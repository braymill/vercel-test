          ...
          <div class='flex-container'>
            <section class='typewriter' className='flex-container' style={{flex: 1}}>
              <div className='about-me-section'>
                ...
                <div style={{justifyContent: 'center'}}>
                  <h3 style={{ fontSize: 22, textAlign: 'center' }}><b>Technologies: React.js, Lambda, DynamoDB</b></h3>
                </div>
                <br/>
            ...
            <section class='content' className='flex-container' style={{flex: 1}}>
              <div className='about-me-section'>
                ...
                <div className='flex-container' style={{justifyContent: 'center', textAlign: 'center'}}>
                  <h3 style={{ fontSize: 22, textAlign: 'center' }}><b>Technologies: Python, Jupyter Notebook</b></h3>
                </div>
                <br/>
                <div className='flex-container' style={{justifyContent: 'center', textAlign: 'center'}}>
          ...
          <div class='flex-container' className='flex-container' style={{flex: 1}}>
            <section class='typewriter'>
              <div class='about-me-section'>
                ...
                <div className='flex-container' style={{justifyContent: 'center'}}>
                  <h3 style={{ fontSize: 22, textAlign: 'center' }}><b>Technologies: React.js, HTML5, CSS, JavaScript</b></h3>
                </div>
                <br/>
                <div className='flex-container' style={{justifyContent: 'center', textAlign: 'center'}}>
                  <SocialMediaIconsReact borderColor="rgba(0,0,0,0.25)" borderWidth="0" borderStyle="solid" icon="github" iconColor="rgba(255,255,255,1)" backgroundColor="rgba(4,74,133,1)" iconSize="5" roundness="20%" url="https://github.com/braymill/braymill.github.io" size="60" />
                </div>
              </div>
            </section>
            <section class='content' className='flex-container' style={{flex: 1}}>
